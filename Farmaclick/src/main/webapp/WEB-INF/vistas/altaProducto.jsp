		...
		<div class = "container">
			<div class="panel panel-default">
			    ...
			    <div class="panel-body">
			    	<form:form action="crearMedicamento" metod="POST" class="form-horizontal" role="form">
					  <div class="form-group">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-lg-4">
					      <textarea class="form-control" id="accion" placeholder="Acción Farmacológica" rows="4"></textarea>
					    </div>
					  </div>
					  <div class="form-group">
